...
func TestDefaultValues(t *testing.T) {
	...
	expected := Configuration{
		...
		Options: OptionsConfiguration{
			...
			ExperimentalVirtualFilesIPFSAPIURL:   "http://127.0.0.1:5001",
			ExperimentalVirtualFilesIPFSTimeoutS: 5,
			ExperimentalVirtualFilesIPFSHealthIntervalS: 30,
		},
		Defaults: Defaults{
...
func TestExperimentalVirtualFilesDefaultDisabled(t *testing.T) {
	...
	if cfg.Options.ExperimentalVirtualFilesIPFSEnabled {
		t.Fatal("expected experimentalVirtualFilesIPFSEnabled to default to false")
	}
	if cfg.Options.ExperimentalVirtualFilesIPFSAPIURL != "http://127.0.0.1:5001" {
		t.Fatalf("unexpected IPFS API default %q", cfg.Options.ExperimentalVirtualFilesIPFSAPIURL)
	}
	if cfg.Options.ExperimentalVirtualFilesIPFSTimeoutS != 5 {
		t.Fatalf("unexpected IPFS timeout default %d", cfg.Options.ExperimentalVirtualFilesIPFSTimeoutS)
	}
	if cfg.Options.ExperimentalVirtualFilesIPFSHealthIntervalS != 30 {
		t.Fatalf("unexpected IPFS health interval default %d", cfg.Options.ExperimentalVirtualFilesIPFSHealthIntervalS)
	}
	if cfg.Options.ExperimentalVirtualFilesIPFSPrefer {
		t.Fatal("expected experimentalVirtualFilesIPFSPrefer to default to false")
	}
}
